...
public class SpacesTestsResources {
    ...
    public static CcSpacesList getSpacesReturnedByCf() {
        ...
        List<CcSpace> spaces = Arrays.asList(
            new CcSpace(UUID.fromString("0a5ea71f-d5f3-4037-9fbe-0029a08f88f1"), "dev", UUID.fromString("c02595b9-4603-4be3-8d71-08243d479918")),
            new CcSpace(UUID.fromString("1824631a-2a96-4bf5-94c0-8687ad6e12db"), "dev", UUID.fromString("ac4f8585-5cba-4c1e-a6bb-4b236fee7fff")),
            new CcSpace(UUID.fromString("63ddabd0-bf28-46d5-a21e-e8e4aa45448f"), "dev", UUID.fromString("af6ccea5-65ee-4601-b95c-3bc09554ca75")));
